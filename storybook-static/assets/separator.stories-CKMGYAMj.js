import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{R as C}from"./index-B5SwJHxK.js";import{c as R}from"./utils-C3T1saKV.js";import"./index-yBjzXJbu.js";import"./index-BlmOqGMO.js";import"./index-BFNyJKjA.js";import"./index-DuqhnXMO.js";import"./index-fNjTmf9T.js";import"./index-CtJ-PWby.js";function t({className:a,orientation:b="horizontal",decorative:w=!0,...z}){return e.jsx(C,{"data-slot":"separator-root",decorative:w,orientation:b,className:R("bg-border shrink-0 data-[orientation=horizontal]:h-px data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-px",a),...z})}t.__docgenInfo={description:"",methods:[],displayName:"Separator",props:{orientation:{defaultValue:{value:'"horizontal"',computed:!1},required:!1},decorative:{defaultValue:{value:"true",computed:!1},required:!1}}};const q={title:"UI/Separator",component:t,tags:["autodocs"],parameters:{layout:"centered"},argTypes:{orientation:{control:{type:"radio"},options:["horizontal","vertical"],description:"The orientation of the separator"},decorative:{control:{type:"boolean"},description:"Whether the separator is decorative or semantic"},className:{control:{type:"text"},description:"Additional CSS classes to apply"}}},r={args:{orientation:"horizontal",decorative:!0},render:a=>e.jsxs("div",{className:"w-[300px]",children:[e.jsx("div",{className:"text-lg font-medium",children:"Content Above"}),e.jsx(t,{...a,className:"my-4"}),e.jsx("div",{className:"text-lg font-medium",children:"Content Below"})]})},o={args:{orientation:"vertical",decorative:!0},render:a=>e.jsxs("div",{className:"flex h-32 items-center",children:[e.jsx("div",{className:"text-lg font-medium",children:"Left"}),e.jsx(t,{...a,className:"mx-4 h-full"}),e.jsx("div",{className:"text-lg font-medium",children:"Right"})]})},s={args:{orientation:"horizontal",decorative:!0},render:a=>e.jsxs("div",{className:"w-[300px]",children:[e.jsx("div",{className:"text-lg font-medium",children:"Gradient Separator"}),e.jsx(t,{...a,className:"my-4 h-1 rounded-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500"}),e.jsx("div",{className:"text-lg font-medium",children:"Content Below"})]})},n={args:{orientation:"horizontal",decorative:!0},render:a=>e.jsxs("div",{className:"w-[300px]",children:[e.jsx("div",{className:"text-lg font-medium",children:"Dotted Separator"}),e.jsx(t,{...a,className:"my-4 border-t-2 border-dotted border-gray-300 bg-transparent"}),e.jsx("div",{className:"text-lg font-medium",children:"Content Below"})]})},i={args:{orientation:"horizontal",decorative:!0},render:a=>e.jsx("div",{className:"w-[400px]",children:e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(t,{...a,className:"flex-1"}),e.jsx("span",{className:"text-sm font-medium text-gray-500",children:"OR"}),e.jsx(t,{...a,className:"flex-1"})]})})};var d,l,m;r.parameters={...r.parameters,docs:{...(d=r.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {
