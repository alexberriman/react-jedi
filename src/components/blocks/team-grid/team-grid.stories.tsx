...
const sampleMembers: TeamMember[] = [
  {
    ...
    achievements: ["Raised $50M in Series B", "Named Forbes 30 Under 30", "Built team from 5 to 200+"],
    socialLinks: [
  ...
  },
  {
    ...
    achievements: ["Reduced infrastructure costs by 60%", "Built auto-scaling platform", "Mentored 15+ engineers"],
    socialLinks: [
  ...
  },
  {
    ...
    achievements: ["Redesigned core product with 40% engagement increase", "Built design system used by 50+ components", "Won Red Dot Design Award"],
    socialLinks: [
  ...
  },
  {
    ...
    achievements: ["Grew ARR from $5M to $50M", "Built sales team of 25+", "Closed largest enterprise deal"],
    socialLinks: [
  ...
  },
  {
    ...
    achievements: ["Increased organic traffic by 300%", "Launched viral marketing campaign", "Built marketing team from 2 to 15"],
    socialLinks: [
  ...
  },
  {
    ...
    achievements: ["Optimized query performance by 80%", "Led microservices migration", "Open source contributor"],
    socialLinks: [
...
const meta: Meta<typeof TeamGrid> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "A comprehensive team grid component with multiple layouts, filtering, search, and modal functionality.",
      },
    },
  },
  tags: ["autodocs", "test"],
...
export const OrgChartLayout: Story = {
  args: {
    ...Default.args,
    variant: "org-chart",
    columns: "3",
