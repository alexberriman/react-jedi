import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{r as c}from"./index-BlmOqGMO.js";import{c as xe}from"./index-DW48STyt.js";import{u as re}from"./index-CtJ-PWby.js";import{c as fe}from"./index-Dkb_ZYRU.js";import{u as ge}from"./index-Dz6nX4BC.js";import{u as je}from"./index-DZ2oWOeb.js";import{u as ve}from"./index-BnD1EARC.js";import{P as de}from"./index-BFNyJKjA.js";import{c as B}from"./utils-C3T1saKV.js";import"./index-yBjzXJbu.js";import"./index-5uDXI3f6.js";import"./index-DuqhnXMO.js";import"./index-fNjTmf9T.js";var y="Switch",[Ne,He]=fe(y),[ke,be]=Ne(y),ie=c.forwardRef((t,a)=>{const{__scopeSwitch:n,name:o,checked:r,defaultChecked:l,required:d,disabled:i,value:h="on",onCheckedChange:E,form:m,...P}=t,[p,u]=c.useState(null),A=re(a,f=>u(f)),R=c.useRef(!1),_=p?m||!!p.closest("form"):!0,[x,pe]=ge({prop:r,defaultProp:l??!1,onChange:E,caller:y});return e.jsxs(ke,{scope:n,checked:x,disabled:i,children:[e.jsx(de.button,{type:"button",role:"switch","aria-checked":x,"aria-required":d,"data-state":he(x),"data-disabled":i?"":void 0,disabled:i,value:h,...P,ref:A,onClick:xe(t.onClick,f=>{pe(ue=>!ue),_&&(R.current=f.isPropagationStopped(),R.current||f.stopPropagation())})}),_&&e.jsx(me,{control:p,bubbles:!R.current,name:o,value:h,checked:x,required:d,disabled:i,form:m,style:{transform:"translateX(-100%)"}})]})});ie.displayName=y;var oe="SwitchThumb",le=c.forwardRef((t,a)=>{const{__scopeSwitch:n,...o}=t,r=be(oe,n);return e.jsx(de.span,{"data-state":he(r.checked),"data-disabled":r.disabled?"":void 0,...o,ref:a})});le.displayName=oe;var we="SwitchBubbleInput",me=c.forwardRef(({__scopeSwitch:t,control:a,checked:n,bubbles:o=!0,...r},l)=>{const d=c.useRef(null),i=re(d,l),h=je(n),E=ve(a);return c.useEffect(()=>{const m=d.current;if(!m)return;const P=window.HTMLInputElement.prototype,u=Object.getOwnPropertyDescriptor(P,"checked").set;if(h!==n&&u){const A=new Event("click",{bubbles:o});u.call(m,n),m.dispatchEvent(A)}},[h,n,o]),e.jsx("input",{type:"checkbox","aria-hidden":!0,defaultChecked:n,...r,tabIndex:-1,ref:i,style:{...r.style,...E,position:"absolute",pointerEvents:"none",opacity:0,margin:0}})});me.displayName=we;function he(t){return t?"checked":"unchecked"}var Se=ie,Ce=le;function s({className:t,...a}){return e.jsx(Se,{"data-slot":"switch",className:B("peer data-[state=checked]:bg-primary data-[state=unchecked]:bg-input focus-visible:border-ring focus-visible:ring-ring/50 dark:data-[state=unchecked]:bg-input/80 inline-flex h-[1.15rem] w-8 shrink-0 items-center rounded-full border border-transparent shadow-xs transition-all outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50",t),...a,children:e.jsx(Ce,{"data-slot":"switch-thumb",className:B("bg-background dark:data-[state=unchecked]:bg-foreground dark:data-[state=checked]:bg-primary-foreground pointer-events-none block size-4 rounded-full ring-0 transition-transform data-[state=checked]:translate-x-[calc(100%-2px)] data-[state=unchecked]:translate-x-0")})})}s.__docgenInfo={description:"",methods:[],displayName:"Switch"};const qe={title:"UI/Switch",component:s,parameters:{docs:{description:{component:`A modern toggle switch component that allows users to switch between on and off states. Built on top of Radix UI Switch.
...
}`,...(L=(U=v.parameters)==null?void 0:U.docs)==null?void 0:L.source}}};var z,H,q;N.parameters={...N.parameters,docs:{...(z=N.parameters)==null?void 0:z.docs,source:{originalSource:`{
