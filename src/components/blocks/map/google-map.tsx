...
export interface GoogleMapProperties extends React.HTMLAttributes<HTMLDivElement> {
  ...
  readonly markers?: GoogleMapMarker[];
  readonly locations?: GoogleMapLocation[];
  ...
  readonly onMarkerClick?: (marker: GoogleMapMarker) => void;
  readonly onLocationSelect?: (location: GoogleMapLocation) => void;
}
...
function GoogleMapBlock({
  ...
  const [selectedLocation, setSelectedLocation] = React.useState<GoogleMapLocation | null>(null);
  ...
  const handleLocationSelect = (location: GoogleMapLocation) => {
  ...
  // Get directions URL
  const getDirectionsUrl = (location: GoogleMapLocation) => {
...
GoogleMapBlock.displayName = "GoogleMap";

export { GoogleMapBlock as GoogleMap };