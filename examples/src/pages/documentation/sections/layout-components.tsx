      ...
      <div className="bg-gradient-to-br from-emerald-900/30 to-blue-900/30 border border-emerald-800/30 rounded-xl p-6 mb-8">
        ...
        <ul className="space-y-2 list-none pl-0">
          <li className="pl-6 relative">
            ...
            Use <span className="font-semibold text-white">Container</span> for page-level content
            organization
          </li>
          <li className="pl-6 relative">
            <span className="absolute left-0 top-1.5 w-2 h-2 rounded-full bg-emerald-500"></span>
          ...
          <li className="pl-6 relative">
            <span className="absolute left-0 top-1.5 w-2 h-2 rounded-full bg-emerald-500"></span>
            Use <span className="font-semibold text-white">Flex</span> for aligning items along a
            single axis
          </li>
          <li className="pl-6 relative">
            <span className="absolute left-0 top-1.5 w-2 h-2 rounded-full bg-emerald-500"></span>
            <span className="font-semibold text-white">Box</span> is perfect for creating card-like
            UI elements
          </li>
        </ul>
      </div>
