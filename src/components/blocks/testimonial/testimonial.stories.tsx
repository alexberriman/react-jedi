...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A flexible testimonial block component supporting multiple layouts, variants, and features like video testimonials, company logos, ratings, and social proof elements.'
      }
    }
  },
  tags: ["autodocs", "test"],
...
const sampleTestimonials = [
  ...
  },
  {
    ...
    content: "The component architecture is brilliant. Easy to customize and extend for our specific needs. Highly recommended for any team looking to move fast.",
    rating: 5,
    date: "September 2024"
  },
  {
...
export const SingleLarge: Story = {
  args: {
    testimonials: {
      ...sampleTestimonial,
      content: "Working with React Jedi has been an absolute pleasure. The Server-Driven UI approach revolutionizes how we think about building interfaces. The component library is comprehensive, the theming system is powerful yet intuitive, and the overall developer experience is unmatched."
    },
    variant: "single",
    layout: "large"
  }
  ...
  args: {
    testimonials: [
      ...
      },
      {
        ...
        content: "This is a much longer testimonial that should demonstrate how the masonry layout handles varying content lengths. The component should automatically adjust the positioning to create a beautiful, Pinterest-style layout."
      },
