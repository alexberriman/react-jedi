...
const meta: Meta<typeof EventListings> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A comprehensive event listings component with multiple display variants, search, filtering, and interactive features for showcasing events and activities.'
      }
    }
  },
  argTypes: {
...
const sampleEvents: Event[] = [
  ...
  },
  {
    ...
    description: 'Monthly event where early-stage startups pitch their ideas to investors and fellow entrepreneurs.',
  ...
  },
  {
    ...
    description: 'Expert discussion on implementing zero trust security models in modern enterprise environments.',
...
export const FeaturedEvent: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Features a prominent hero-style display for the featured event, with remaining events in a grid below.'
      }
    }
  }
}
...
export const TimelineView: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Timeline layout showing events in chronological order with alternating card positions.'
      }
    }
  }
}
...
export const WithCustomEvents: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Example with custom event data for specialized use cases like product launches and team events.'
      }
    }
  }
}
...
export const InteractiveExample: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Interactive example with click handlers for event details and registration actions.'
      }
    }
  }
}
