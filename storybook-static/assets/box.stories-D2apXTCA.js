import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{B as o}from"./box-y1AJ49W5.js";import"./index-yBjzXJbu.js";import"./index-Y0L-LdVC.js";import"./utils-C3T1saKV.js";const X={title:"Components/Layout/Box",component:o,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{display:{control:"select",options:["block","flex","inline","inline-block","grid","inline-flex","inline-grid","none"],description:"Controls the display CSS property"},position:{control:"select",options:["static","relative","absolute","fixed","sticky"],description:"Controls the positioning method"},padding:{control:"select",options:["none","xs","sm","md","lg","xl","2xl"],description:"Controls the padding on all sides"},margin:{control:"select",options:["none","xs","sm","md","lg","xl","2xl","auto"],description:"Controls the margin on all sides"},rounded:{control:"select",options:["none","sm","md","lg","xl","2xl","3xl","full"],description:"Controls the border radius (roundness of corners)"},shadow:{control:"select",options:["none","sm","md","lg","xl","2xl","inner"],description:"Controls the box shadow"},width:{control:"select",options:["auto","full","screen","fit","min","max","half","third","two-thirds","quarter","three-quarters"],description:"Controls the width of the box"},height:{control:"select",options:["auto","full","screen","fit","min","max","half","third","two-thirds","quarter","three-quarters"],description:"Controls the height of the box"},borderWidth:{control:"select",options:["none","thin","thick","thicker","thickest"],description:"Controls the border width"},backgroundColor:{control:"select",options:["transparent","primary","secondary","accent","muted","card","background","foreground","destructive","popover"],description:"Controls the background color"},textColor:{control:"select",options:["primary","secondary","accent","muted","card","background","foreground","destructive","popover"],description:"Controls the text color"},borderColor:{control:"select",options:["default","primary","secondary","accent","muted","card","background","foreground","destructive","popover"],description:"Controls the border color"},flexDirection:{control:"select",options:["row","row-reverse","col","col-reverse"],description:"Controls the direction of flex items when display is flex"},justifyContent:{control:"select",options:["start","end","center","between","around","evenly"],description:"Controls the alignment of flex items along the main axis"},alignItems:{control:"select",options:["start","end","center","baseline","stretch"],description:"Controls the alignment of flex items along the cross axis"},gap:{control:"select",options:["none","xs","sm","md","lg","xl","2xl"],description:"Controls the gap between grid/flex items"},overflow:{control:"select",options:["auto","hidden","visible","scroll","x-auto","y-auto","x-hidden","y-hidden","x-scroll","y-scroll"],description:"Controls how content overflows the box"},zIndex:{control:"select",options:["auto","0","10","20","30","40","50"],description:"Controls the stacking order"},transition:{control:"select",options:["none","default","fast","slow"],description:"Controls transition effects"},scale:{control:"select",options:["none","sm","md","lg","xl"],description:"Controls the scale transform"},blur:{control:"select",options:["none","sm","md","lg","xl","2xl","3xl"],description:"Controls the blur filter effect"},backdropBlur:{control:"select",options:["none","sm","md","lg","xl","2xl","3xl"],description:"Controls the backdrop blur effect"},glassmorphism:{control:"select",options:["none","light","medium","strong","dark","dark-medium","dark-strong"],description:"Applies glass morphism effect variants"},neumorphism:{control:"select",options:["none","light","medium","strong","dark","dark-medium","dark-strong"],description:"Applies neumorphism effect variants"},as:{control:"select",options:["div","section","article","main","aside","header","footer","nav"],description:"Renders the box as a different HTML element"}}},n={render:r=>e.jsx(o,{...r,className:"min-h-[200px] min-w-[200px] flex items-center justify-center",children:e.jsx("p",{className:"text-xl font-medium",children:"Default Box"})})},t={args:{padding:"lg",rounded:"lg",shadow:"md",backgroundColor:"card",borderWidth:"thin",borderColor:"default"},render:r=>e.jsx(o,{...r,className:"min-h-[200px] min-w-[200px] flex items-center justify-center",children:e.jsx("p",{className:"text-xl font-medium",children:"Styled Box"})})},s={args:{display:"flex",flexDirection:"col",gap:"md",padding:"md",justifyContent:"center",alignItems:"center",backgroundColor:"muted",rounded:"md"},render:r=>e.jsxs(o,{...r,className:"min-h-[300px] min-w-[300px]",children:[e.jsx(o,{padding:"sm",backgroundColor:"primary",rounded:"md",textColor:"primary",className:"w-full text-center",children:"Item 1"}),e.jsx(o,{padding:"sm",backgroundColor:"secondary",rounded:"md",textColor:"secondary",className:"w-full text-center",children:"Item 2"}),e.jsx(o,{padding:"sm",backgroundColor:"accent",rounded:"md",textColor:"accent",className:"w-full text-center",children:"Item 3"})]})},a={args:{display:"grid",gap:"md",padding:"md",rounded:"md",backgroundColor:"muted",className:"grid-cols-2"},render:r=>e.jsxs(o,{...r,className:"min-h-[300px] min-w-[300px]",children:[e.jsx(o,{padding:"sm",backgroundColor:"primary",rounded:"md",textColor:"primary",className:"text-center",children:"Grid Item 1"}),e.jsx(o,{padding:"sm",backgroundColor:"secondary",rounded:"md",textColor:"secondary",className:"text-center",children:"Grid Item 2"}),e.jsx(o,{padding:"sm",backgroundColor:"accent",rounded:"md",textColor:"accent",className:"text-center",children:"Grid Item 3"}),e.jsx(o,{padding:"sm",backgroundColor:"primary",rounded:"md",textColor:"primary",className:"text-center",children:"Grid Item 4"})]})},d={args:{glassmorphism:"medium",padding:"lg",rounded:"xl"},render:r=>e.jsx(o,{className:"w-[400px] h-[300px] bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center",children:e.jsx(o,{...r,className:"w-[300px] h-[200px] flex items-center justify-center",children:e.jsx("p",{className:"text-xl font-medium text-white",children:"Glassmorphism Box"})})})},l={args:{neumorphism:"medium",padding:"lg",rounded:"xl"},render:r=>e.jsx(o,{backgroundColor:"background",className:"w-[400px] h-[300px] flex items-center justify-center",children:e.jsx(o,{...r,className:"w-[300px] h-[200px] flex items-center justify-center",children:e.jsx("p",{className:"text-xl font-medium",children:"Neumorphism Box"})})})},c={args:{position:"absolute",padding:"md",backgroundColor:"primary",textColor:"primary",rounded:"md"},render:r=>e.jsx(o,{position:"relative",className:"w-[300px] h-[300px] border border-border",children:e.jsx(o,{...r,className:"m-4 top-0 left-0",children:"Absolute Positioned Box"})})},i={args:{padding:"md",rounded:"md",backgroundColor:"accent",transition:"default",shadow:"md",className:"hover:shadow-xl hover:scale-105"},render:r=>e.jsx(o,{...r,className:"w-[200px] h-[200px] flex items-center justify-center",children:e.jsx("p",{className:"text-lg font-medium text-accent-foreground",children:"Hover Me"})})},m={args:{height:"full",width:"full",overflow:"y-auto",padding:"md",backgroundColor:"card",rounded:"md",shadow:"md"},render:r=>e.jsxs(o,{...r,className:"w-[300px] h-[200px]",children:[e.jsx("p",{className:"mb-4",children:"This box has scrollable content that exceeds its height:"}),Array.from({length:10}).map((O,x)=>e.jsxs("p",{className:"mb-4",children:["Scrollable content paragraph ",x+1,". Lorem ipsum dolor sit amet, consectetur adipiscing elit."]},x))]})},p={args:{backdropBlur:"xl",padding:"lg",rounded:"lg",backgroundColor:"background",className:"bg-opacity-50"},render:r=>e.jsx(o,{className:"relative w-[400px] h-[300px]",children:e.jsxs(o,{className:"w-full h-full flex items-center justify-center",children:[e.jsx("img",{src:"https://source.unsplash.com/random/400x300?nature",alt:"Nature",className:"w-full h-full object-cover absolute inset-0 rounded-lg"}),e.jsx(o,{...r,className:"absolute inset-0 m-8 flex items-center justify-center",children:e.jsx("p",{className:"text-xl font-bold",children:"Text with Backdrop Blur"})})]})})};var u,g,h;n.parameters={...n.parameters,docs:{...(u=n.parameters)==null?void 0:u.docs,source:{originalSource:`{
...
}`,...(q=(W=c.parameters)==null?void 0:W.docs)==null?void 0:q.source}}};var L,P,_;i.parameters={...i.parameters,docs:{...(L=i.parameters)==null?void 0:L.docs,source:{originalSource:`{
  args: {
    padding: "md",
    rounded: "md",
...
}`,...(_=(P=i.parameters)==null?void 0:P.docs)==null?void 0:_.source}}};var H,M,E;m.parameters={...m.parameters,docs:{...(H=m.parameters)==null?void 0:H.docs,source:{originalSource:`{
  args: {
    height: "full",
    width: "full",
    overflow: "y-auto",
