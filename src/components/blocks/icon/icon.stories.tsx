...
const iconLibrary: IconItem[] = [
  ...
  { icon: Fi.FiCornerUpLeft, name: 'FiCornerUpLeft', category: 'Navigation', importPath: 'react-icons/fi' },
  ...
  { icon: Fi.FiCalendar, name: 'FiCalendar', category: 'UI Elements', importPath: 'react-icons/fi' },
  ...
  { icon: Fi.FiShoppingBag, name: 'FiShoppingBag', category: 'Business', importPath: 'react-icons/fi' },
  { icon: Fi.FiShoppingCart, name: 'FiShoppingCart', category: 'Business', importPath: 'react-icons/fi' },
  ...
  { icon: Fi.FiAlertTriangle, name: 'FiAlertTriangle', category: 'Security', importPath: 'react-icons/fi' },
  { icon: Fi.FiAlertCircle, name: 'FiAlertCircle', category: 'Security', importPath: 'react-icons/fi' },
