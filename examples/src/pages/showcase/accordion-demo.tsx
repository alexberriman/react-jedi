    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <section className="space-y-4">
          <h1 className="text-4xl font-bold text-emerald-400">Accordion Component</h1>
        ...
        <section className="space-y-6">
          <div>
            ...
            <p className="text-zinc-400">Only one item can be expanded at a time.</p>
          </div>
        ...
        <section className="space-y-6">
          <div>
            ...
            <p className="text-zinc-400">Multiple items can be expanded at the same time.</p>
          </div>
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="bg-zinc-900 rounded-lg border border-zinc-800 p-6">
              <h3 className="text-lg font-semibold text-emerald-400 mb-3">Accordion Properties</h3>
              <dl className="space-y-3">
                <div>
                  <dt className="font-mono text-sm text-zinc-300">type</dt>
                  <dd className="text-sm text-zinc-400 mt-1">Must be &quot;Accordion&quot;</dd>
                </div>
                <div>
                  <dt className="font-mono text-sm text-zinc-300">accordionType</dt>
                ...
                <div>
                  <dt className="font-mono text-sm text-zinc-300">defaultValue</dt>
                  <dd className="text-sm text-zinc-400 mt-1">
                    string | string[] - The default expanded item(s)
                  </dd>
                </div>
                <div>
                  <dt className="font-mono text-sm text-zinc-300">collapsible</dt>
                  <dd className="text-sm text-zinc-400 mt-1">
                ...
                <div>
                  <dt className="font-mono text-sm text-zinc-300">disabled</dt>
                  <dd className="text-sm text-zinc-400 mt-1">
            ...
            <div className="bg-zinc-900 rounded-lg border border-zinc-800 p-6">
              ...
              <dl className="space-y-3">
                <div>
                  <dt className="font-mono text-sm text-zinc-300">type</dt>
                  <dd className="text-sm text-zinc-400 mt-1">Must be &quot;AccordionItem&quot;</dd>
                </div>
                <div>
                  <dt className="font-mono text-sm text-zinc-300">value</dt>
                  <dd className="text-sm text-zinc-400 mt-1">
