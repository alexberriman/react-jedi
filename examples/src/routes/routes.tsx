...
const FeaturesShowcase = lazy(() =>
  import("../pages/showcase/blocks/features").then((module) => ({ default: module.FeaturesShowcasePage }))
);
...
const JobListingsShowcase = lazy(() =>
  import("../pages/showcase/blocks/job-listings").then((module) => ({ default: module.JobListingsShowcasePage }))
);
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              {
                path: "features",
                element: <AsyncRoute component={FeaturesShowcase} loadingText="Loading features block..." />,
              },
              {
                path: "feature-card",
              ...
              {
                path: "job-listings",
                element: <AsyncRoute component={JobListingsShowcase} loadingText="Loading job listings block..." />,
              },
              {
                path: "brand-logo-bar",
